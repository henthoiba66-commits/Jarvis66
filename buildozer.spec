...
requirements = python3,kivy,gtts,requests,certifi,chardet,idna,urllib3
...
#android.add_resources = source_res_dir_relative_path
...
# (str) python-for-android fork to use in case if p4a.branch is not virgin upstream
#p4a.fork = kivy
